...
<html>
    <head>
        <jsp:include page="admin-main-layout.jsp"></jsp:include>
            <title>REPORT ${pro.productName} (${dateRange})</title>
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header">
                                        <h3 class="box-title">PRODUCT REPORT (${dateRange})</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <div class="row invoice-info">
                                        <div class="col-sm-4 invoice-col">
                                            ...
                                            <address>
                                                <b>Name:</b> ${pro.productName}<br/>
                                                <b>ID:</b> ${pro.productID}<br/>
                                                <b>Brand:</b> ${pro.brandID.brandName}<br/>
                                                <b>Category:</b> ${pro.categoryID.categoryName}<br/>
                                            </address>
                                        </div><!-- /.col -->
                                        <div class="col-sm-4 invoice-col">
