...
<html>
    <head>
        ...
        <%
            ...
            session.setAttribute("currentAdminPageChild", "addReportCustomer");
        %>
        <div class="wrapper">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="customerID" required="true">
                                                        ...
                                                        <option value="${b.customerID}">${b.firstName} ${b.lastName}/${b.email}</option>
                                                    </c:forEach>                                                                                    
                                                </select>
                                            </div>                                                   
                                        </div>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('#reservation').val('01/01/' + d + ' - 12/31/' + d);
